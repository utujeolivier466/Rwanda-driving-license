...
<head>
    ...
    <title>Register - Rwanda Driving License</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Join our driving license system</p>
        </div>
        ...
        <form action="<?php echo e(route('register.store')); ?>" method="post" class="space-y-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-sm text-gray-600 mt-4">
                ...
                <a href="/" class="text-blue-600 font-medium">Sign in here</a>
            </p>
        </form>
    </div>
</body>
...
<?php /**PATH C:\xampp\htdocs\Rwanda_Driving_License-main\resources\views/auth/register.blade.php ENDPATH**/ ?>